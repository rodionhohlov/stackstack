...
MAINFILES = main.cpp stkType.cpp calc.cpp asm_funcs.cpp

COMPFILES = converter\main.cpp converter\translate_funcs.cpp

compilation:
	$(CC) $(CFLAGS) $(COMPFILES) -o bytecode

program:  
	$(CC) $(CFLAGS) $(MAINFILES) -o program
